...
return (
	...
	<div className="text-center">		
		<div className=" text-center">		
			<h4 className="text-center py-2 text-2xl text-red-400">Calculate Next period, Ovulation Day </h4>
		</div>
		
		

		<label for="cycle" className="py-2">Select your Cycle Length : </label>
		<select
